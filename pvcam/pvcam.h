/******************************************************************************
   Copyright (C) Roper Scientific, Inc. 1990-2000.
                 Princeton Instruments/Acton 2006.

   All rights reserved.
******************************************************************************/
#ifndef _PVCAM_H
#define _PVCAM_H
// static const char *_pvcam_h_="$Header: /PVCAM V2.6/SourceCommon/pvcam.h   2   2006-05-25 10:06:20-04:00   skatsumata $";
...
#define PARAM_FTSCAN                ((CLASS2<<16) + (TYPE_UNS16<<24)     +  59) 

/* customize chip dimension */
#define PARAM_CUSTOM_CHIP           ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   +  87)   

/* customize chip timing */
#define PARAM_CUSTOM_TIMING         ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   +  88)
#define PARAM_PAR_SHIFT_TIME        ((CLASS2<<16) + (TYPE_UNS32<<24)     + 545)
#define PARAM_SER_SHIFT_TIME        ((CLASS2<<16) + (TYPE_UNS32<<24)     + 546)

/* Kinetics Window Size */
#define PARAM_KIN_WIN_SIZE          ((CLASS2<<16) + (TYPE_UNS16<<24)     + 126)
